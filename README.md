...
<p align="center">
  <img src="landing/static/assets/screenshots/desktop/desktop_main.webp" width="49%" alt="Desktop Main Shell" loading="lazy" />
  <img src="landing/static/assets/screenshots/desktop/desktop_livePreviewEditor.webp" width="49%" alt="Live Preview Markdown Editor" loading="lazy" />
</p>
<p align="center">
  <img src="landing/static/assets/screenshots/desktop/desktop_versionHistoryDiff.webp" width="49%" alt="Visual Git-like Diff Version History" loading="lazy" />
  <img src="landing/static/assets/screenshots/desktop/desktop_syncSettings.webp" width="49%" alt="WebDAV Sync Configuration" loading="lazy" />
</p>
...
<p align="center">
  <img src="landing/static/assets/screenshots/mobile/mobile_sidebar_detailed.webp" width="32%" alt="Navigation Drawer" loading="lazy" />
  <img src="landing/static/assets/screenshots/mobile/mobile_syncReport.webp" width="32%" alt="Detailed Synchronization Report" loading="lazy" />
  <img src="landing/static/assets/screenshots/mobile/mobile_versionHistory.webp" width="32%" alt="Flat Snapshot History Viewer" loading="lazy" />
</p>

### 🧭 Safari Native Web Clipper Extension
<p align="center">
  <img src="landing/static/assets/screenshots/clipper/clipper_clippingAllPage.webp" width="49%" alt="Clipper Parsing Full DOM" loading="lazy" />
  <img src="landing/static/assets/screenshots/clipper/clipper_clippedNote.webp" width="49%" alt="Parsed Markdown Preview" loading="lazy" />
</p>
